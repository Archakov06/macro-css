...
| `m-25`                    | `margin: 25px;`                                                                   |
| `p-50`                    | `padding: 50px;`                                                                  |
| `pl-10 pr-10 mt-15 mb-15` | `padding-left: 10px; padding-right: 10px; margin-top: 15px; margin-bottom: 15px;` |
...
| Класс | Значение                                                                                                                                            |
| ----- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| clear | Очищает базовые стили, которые устанавливает браузер для: <a>, <ul>, <li>. Для всех (\*) остальных элементов: box-sizing: border-box; outline: none |
